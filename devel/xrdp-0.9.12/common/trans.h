...
//add extra code by yuliang
typedef struct MyTransInfo{
	//fifoFd[0],Data of master to slave
	//fifoFd[1],Data of slave to master
	int fifoFd[2];
	int session_type;
	char fifoname1[512];
	char fifoname2[512];
...
enum SessionType mytrans_get_session_type(MyTransInfo_t*self,\
